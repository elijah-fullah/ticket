...
class ThreeLineWidget extends StatefulWidget {
  const ThreeLineWidget({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  _ThreeLineWidgetState createState() => _ThreeLineWidgetState();
}

class _ThreeLineWidgetState extends State<ThreeLineWidget> {
