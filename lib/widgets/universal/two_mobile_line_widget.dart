...
class TwoMobileLineWidget extends StatefulWidget {
  const TwoMobileLineWidget({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  _TwoMobileLineWidgetState createState() => _TwoMobileLineWidgetState();
}

class _TwoMobileLineWidgetState extends State<TwoMobileLineWidget> {
