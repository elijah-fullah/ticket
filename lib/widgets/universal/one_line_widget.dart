...
class OneLineWidget extends StatefulWidget {
  const OneLineWidget({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  _OneLineWidgetState createState() => _OneLineWidgetState();
}

class _OneLineWidgetState extends State<OneLineWidget> {
