...
class TwoWebLineWidget extends StatefulWidget {
  const TwoWebLineWidget({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  _TwoWebLineWidgetState createState() => _TwoWebLineWidgetState();
}

class _TwoWebLineWidgetState extends State<TwoWebLineWidget> {
