...
class SuperWebLineWidget extends StatefulWidget {
  const SuperWebLineWidget({super.key, required this.isShowingMainData});

  final bool isShowingMainData;

  @override
  _SuperWebLineWidgetState createState() => _SuperWebLineWidgetState();
}

class _SuperWebLineWidgetState extends State<SuperWebLineWidget> {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    switch (value.toInt()) {
      case 1:
        ...
        break;
      case 2:
        text = const ChartHeading(text: 'FEB');
        break;
      case 3:
        text = const ChartHeading(text: 'MAR');
        break;
      case 4:
        text = const ChartHeading(text: 'APR');
        break;
      case 5:
        text = const ChartHeading(text: 'MAY');
        break;
      case 6:
        text = const ChartHeading(text: 'JUN');
        break;
      case 7:
        text = const ChartHeading(text: 'JUL');
        break;
      case 8:
        text = const ChartHeading(text: 'AUG');
        break;
      case 9:
        text = const ChartHeading(text: 'SEP');
        break;
      case 10:
        text = const ChartHeading(text: 'OCT');
        break;
      case 11:
        text = const ChartHeading(text: 'NOV');
        break;
      case 12:
        text = const ChartHeading(text: 'DEC');
        break;
      default:
