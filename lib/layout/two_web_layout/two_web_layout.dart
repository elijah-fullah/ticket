...
import '../../controllers/two_web_sidebar_controller/two_web_sidebar_controller.dart';
...
class TwoWebLayout extends StatefulWidget {
  const TwoWebLayout({
    super.key,
  });

  @override
  State<TwoWebLayout> createState() => _TwoWebLayoutState();
}

class _TwoWebLayoutState extends State<TwoWebLayout> {
  final TwoWebSidebarController twoSidebarController = Get.put(TwoWebSidebarController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(
        children: [
          Obx(() {
            final isExpanded = twoSidebarController.isExpanded.value;
                ...
                children: [
                  ...
                  Column(
                    children: [
                      ...
                      buildListTile(1, Icons.report, isExpanded ? 'Reports' : ''),
                      buildListTile(2, FluentSystemIcons.ic_fluent_send_logging_filled, isExpanded ? 'Logs' : ''),
                    ],
                  ),
                  Column(
                    children: [
                      ...
                      buildListTile(3, Icons.settings, isExpanded ? 'Settings' : ''),
                      ListTile(
                        onTap: () {
                          AwesomeDialog(
                              context: context,
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            IconButton(
                              onPressed: () {
                                twoSidebarController.isExpanded.toggle();
                              },
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          child: Obx(() {
                            return Navigator(
                              key: Get.nestedKey(twoSidebarController.index.value), // Use nestedKey here
                              onGenerateRoute: (settings) {
                                return MaterialPageRoute(
                                  builder: (context) => twoSidebarController.pages[twoSidebarController.index.value],
                                );
                              },
                            );
                          }),
  ...
  Widget buildListTile(int index, IconData icon, String text) {
    return Obx(() {
      final isSelected = twoSidebarController.index.value == index;
      final isExpanded = twoSidebarController.isExpanded.value;
      return Padding(
        ...
        child: Container(
          ...
          child: ListTile(
            onTap: () => twoSidebarController.index.value = index,
            selected: isSelected,
            leading: Icon(
                icon,
                size: 25,
