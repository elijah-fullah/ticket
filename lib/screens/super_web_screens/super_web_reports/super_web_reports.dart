...
import 'package:ticket/screens/super_web_screens/super_web_reports/super_web_integrity.dart';
import 'package:ticket/screens/super_web_screens/super_web_reports/super_web_unverified.dart';
import 'package:ticket/screens/super_web_screens/super_web_reports/super_web_verified.dart';
...
class SuperWebReports extends StatefulWidget {
  const SuperWebReports({super.key});

  @override
  State<SuperWebReports> createState() => _LogsState();
}

class _LogsState extends State<SuperWebReports> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              const WebHeading1(text: 'Reports'),
              Row(
                children: [
                  const AllText(),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const SuperWebVerified(), id: 3);},
                    icon: Icons.verified,
                    text: 'Verified',
                  ),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const SuperWebUnverified(), id: 3);},
                    icon: Icons.hourglass_empty,
                    text: 'Unverified',
                  ),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const SuperWebIntegrity(), id: 3);},
