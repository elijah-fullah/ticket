...
class SuperWebVerified extends StatefulWidget {
  const SuperWebVerified({super.key});

  @override
  State<SuperWebVerified> createState() => _LogsState();
}

class _LogsState extends State<SuperWebVerified> {
