...
class SuperWebIntegrity extends StatefulWidget {
  const SuperWebIntegrity({super.key});

  @override
  State<SuperWebIntegrity> createState() => _LogsState();
}

class _LogsState extends State<SuperWebIntegrity> {
