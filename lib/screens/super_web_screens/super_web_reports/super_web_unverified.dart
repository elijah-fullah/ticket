...
class SuperWebUnverified extends StatefulWidget {
  const SuperWebUnverified({super.key});

  @override
  State<SuperWebUnverified> createState() => _LogsState();
}

class _LogsState extends State<SuperWebUnverified> {
