...
import 'package:ticket/screens/super_web_screens/super_web_tickets/super_web_add_ticket.dart';
...
class SuperWebTickets extends StatefulWidget {
  const SuperWebTickets({super.key});

  @override
  State<SuperWebTickets> createState() => _SuperWebTicketsState();
}

class _SuperWebTicketsState extends State<SuperWebTickets> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WebElevatedButton(
                onTap: () {
                  Get.to(() => const SuperWebAddTicket(), id: 2);
                },
