...
import 'one_web_add_ticket.dart';

class OneWebTickets extends StatefulWidget {
  const OneWebTickets({super.key});

  @override
  State<OneWebTickets> createState() => _OneWebTicketsState();
}

class _OneWebTicketsState extends State<OneWebTickets> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WebElevatedButton(
                onTap: () {
                  Get.to(() => const OneWebAddTicket(), id: 1);
                },
