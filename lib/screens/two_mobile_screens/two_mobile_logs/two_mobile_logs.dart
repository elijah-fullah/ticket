...
class TwoMobileLogs extends StatefulWidget {
  const TwoMobileLogs({super.key});

  @override
  State<TwoMobileLogs> createState() => _TwoMobileLogsState();
}

class _TwoMobileLogsState extends State<TwoMobileLogs> {
