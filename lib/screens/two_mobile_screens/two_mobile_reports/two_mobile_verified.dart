...
class TwoMobileVerified extends StatefulWidget {
  const TwoMobileVerified({super.key});

  @override
  State<TwoMobileVerified> createState() => _TwoMobileVerifiedState();
}

class _TwoMobileVerifiedState extends State<TwoMobileVerified> {
