...
class TwoMobileScanners extends StatefulWidget {
  const TwoMobileScanners({super.key});

  @override
  State<TwoMobileScanners> createState() => _TwoMobileScannersState();
}

class _TwoMobileScannersState extends State<TwoMobileScanners> {
