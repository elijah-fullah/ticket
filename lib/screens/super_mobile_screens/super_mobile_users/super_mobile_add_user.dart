...
class SuperMobileAddUser extends StatefulWidget {
  const SuperMobileAddUser({super.key});

  @override
  State<SuperMobileAddUser> createState() => _SuperMobileAddUserState();
}

class _SuperMobileAddUserState extends State<SuperMobileAddUser> {
        ...
        body: NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
              SliverAppBar(
                ...
                title: AppBarHeading1(text: 'Add User'),
              )
            ],
