...
class SuperMobileIntegrity extends StatefulWidget {
  const SuperMobileIntegrity({super.key});

  @override
  State<SuperMobileIntegrity> createState() => _SuperMobileIntegrityState();
}

class _SuperMobileIntegrityState extends State<SuperMobileIntegrity> {
