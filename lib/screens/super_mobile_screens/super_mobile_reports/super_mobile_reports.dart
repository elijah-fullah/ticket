...
import 'package:ticket/screens/super_mobile_screens/super_mobile_reports/super_mobile_integrity.dart';
import 'package:ticket/screens/super_mobile_screens/super_mobile_reports/super_mobile_unverified.dart';
import 'package:ticket/screens/super_mobile_screens/super_mobile_reports/super_mobile_verified.dart';
...
class SuperMobileReports extends StatefulWidget {
  const SuperMobileReports({super.key});

  @override
  State<SuperMobileReports> createState() => _SuperMobileReportsState();
}

class _SuperMobileReportsState extends State<SuperMobileReports> {
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          const AllText(),
                          const Gap(10),
                          MobileElevatedButton(onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => SuperMobileVerified()));},
                            icon: Icons.verified,
                            text: 'Verified',
                          ),
                          const Gap(10),
                          MobileElevatedButton(onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => SuperMobileUnverified()));},
                            icon: Icons.hourglass_empty,
                            text: 'Unverified',
                          ),
                          const Gap(10),
                          MobileElevatedButton(onTap: () {Navigator.push(context, MaterialPageRoute(builder: (context) => SuperMobileIntegrity()));},
