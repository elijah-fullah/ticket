...
class SuperMobileVerified extends StatefulWidget {
  const SuperMobileVerified({super.key});

  @override
  State<SuperMobileVerified> createState() => _SuperMobileVerifiedState();
}

class _SuperMobileVerifiedState extends State<SuperMobileVerified> {
        ...
        header: (context) => pw.Row(
            ...
            children: [
              ...
              pw.Column(
                  ...
                  children: [
                    pw.Text('Verified', style: pw.TextStyle(font: bold, fontWeight: pw.FontWeight.bold, color: pdfBackgroundHeader)),
        ...
        body: NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
              SliverAppBar(
                ...
                title: AppBarHeading1(text: 'Verified'),
              )
            ],
