...
class SuperMobileAddTicket extends StatefulWidget {
  const SuperMobileAddTicket({super.key});

  @override
  State<SuperMobileAddTicket> createState() => _SuperMobileAddTicketState();
}

class _SuperMobileAddTicketState extends State<SuperMobileAddTicket> {
        ...
        body: NestedScrollView(
            headerSliverBuilder: (context, innerBoxIsScrolled) => [
              SliverAppBar(
                ...
                title: AppBarHeading1(text: 'Add Ticket'),
              )
            ],
