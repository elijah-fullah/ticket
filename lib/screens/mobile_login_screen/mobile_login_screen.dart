...
import 'package:ticket/layout/one_mobile_layout/one_mobile_layout.dart';
import 'package:ticket/layout/super_mobile_layout/super_mobile_layout.dart';
import 'package:ticket/layout/three_mobile_layout/three_mobile_layout.dart';
import 'package:ticket/layout/two_mobile_layout/two_mobile_layout.dart';
import 'package:ticket/widgets/universal/title_text.dart';
import '../../../constants/colors/colors.dart';
import '../../../widgets/universal/web_elevated_action_button.dart';
import '../../widgets/universal/mobile_login_password_field_widget.dart';
import '../../widgets/universal/mobile_login_text_field_widget.dart';
          ...
          switch (role) {
            case 'Super':
              sharedPreferences.setString('userId', email).then((_) {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const SuperMobileLayout()),
                );
              });
              break;
            case 'Level One':
              sharedPreferences.setString('userId', email).then((_) {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const OneMobileLayout()),
                );
              });
              break;
            case 'Level Two':
              sharedPreferences.setString('userId', email).then((_) {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const TwoMobileLayout()),
                );
              });
              break;
            case 'Level Three':
              sharedPreferences.setString('userId', email).then((_) {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const ThreeMobileLayout()),
                );
              });
              break;
            default:
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Gap(20),
            MobileLoginTextFieldWidget(
                controller: emailController,
                type: TextInputType.emailAddress,
                hint: 'Email',
                icon: Icons.email
            ),
            MobileLoginPasswordFieldWidget(
