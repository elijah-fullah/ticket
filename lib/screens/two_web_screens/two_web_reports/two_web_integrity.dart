...
class TwoWebIntegrity extends StatefulWidget {
  const TwoWebIntegrity({super.key});

  @override
  State<TwoWebIntegrity> createState() => _LogsState();
}

class _LogsState extends State<TwoWebIntegrity> {
