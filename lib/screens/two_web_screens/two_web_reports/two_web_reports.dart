...
import 'package:ticket/screens/two_web_screens/two_web_reports/two_web_integrity.dart';
import 'package:ticket/screens/two_web_screens/two_web_reports/two_web_unverified.dart';
import 'package:ticket/screens/two_web_screens/two_web_reports/two_web_verified.dart';
...
class TwoWebReports extends StatefulWidget {
  const TwoWebReports({super.key});

  @override
  State<TwoWebReports> createState() => _LogsState();
}

class _LogsState extends State<TwoWebReports> {
            ...
            children: [
              ...
              Row(
                children: [
                  const AllText(),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const TwoWebVerified(), id: 1);},
                    icon: Icons.verified,
                    text: 'Verified',
                  ),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const TwoWebUnverified(), id: 1);},
                    icon: Icons.hourglass_empty,
                    text: 'Unverified',
                  ),
                  const Gap(10),
                  WebElevatedButton(onTap: () {Get.to(() => const TwoWebIntegrity(), id: 1);},
