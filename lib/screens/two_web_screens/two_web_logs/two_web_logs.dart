...
import '../../super_web_screens/super_web_logs/super_web_add_logs.dart';

class TwoWebLogs extends StatefulWidget {
  const TwoWebLogs({super.key});

  @override
  State<TwoWebLogs> createState() => _TwoWebLogsState();
}

class _TwoWebLogsState extends State<TwoWebLogs> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WebElevatedButton(
                onTap: () {
                  Get.to(() => const SuperWebAddLogs(), id: 2);
                },
