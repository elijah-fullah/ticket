...
import '../../../widgets/universal/three_line_widget.dart';
...
class ThreeWebDashboard extends StatefulWidget {
  const ThreeWebDashboard({super.key});

  @override
  State<ThreeWebDashboard> createState() => _ThreeWebDashboardState();
}

class _ThreeWebDashboardState extends State<ThreeWebDashboard> {
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ThreeLineWidget(isShowingMainData: isShowingMainData),
                      ),
                    ),
                  ],
                ),
