...
class ThreeWebEditUser extends StatefulWidget {
  final QueryDocumentSnapshot<Map<String, dynamic>> data;
  const ThreeWebEditUser({super.key, required this.data});

  @override
  State<ThreeWebEditUser> createState() => _ThreeWebEditUserState();
}

class _ThreeWebEditUserState extends State<ThreeWebEditUser> {
