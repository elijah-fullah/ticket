...
class ThreeWebAddUser extends StatefulWidget {
  const ThreeWebAddUser({super.key});

  @override
  State<ThreeWebAddUser> createState() => _ThreeWebAddUserState();
}

class _ThreeWebAddUserState extends State<ThreeWebAddUser> {
  ...
  String? val;
  List<String> types = ['Level One', 'Level Two'];
  ...
  Future<void> addUser(BuildContext context, String uid) async {
    ...
    try {
      ...
      // Check if the email already exists in the 'users' or 'customers' collection
      ...
      // Check if the contact already exists in the 'users' or 'customers' collection
      ...
      // Check if either email or contact exists
