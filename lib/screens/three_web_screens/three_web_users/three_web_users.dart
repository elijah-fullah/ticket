...
import 'package:ticket/screens/three_web_screens/three_web_users/three_web_add_user.dart';
import 'package:ticket/screens/three_web_screens/three_web_users/three_web_edit_user.dart';
...
class ThreeWebUsers extends StatefulWidget {
  const ThreeWebUsers({super.key});

  @override
  State<ThreeWebUsers> createState() => _ThreeWebUsersState();
}

class _ThreeWebUsersState extends State<ThreeWebUsers> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WebElevatedButton(
                onTap: () {
                  Get.to(() => const ThreeWebAddUser(), id: 1);
                },
            ...
            child: Column(
              children: [
                ...
                Expanded(
                  flex: 7,
                  child: StreamBuilder<
                      List<QueryDocumentSnapshot<Map<String, dynamic>>>>(stream: usersStream, builder: (BuildContext context, AsyncSnapshot<List<QueryDocumentSnapshot<Map<String, dynamic>>>>snapshot) {
      ...
      cells: [
        ...
        DataCell(
          UserAction(
            ...
            edit: () {Get.to(() => ThreeWebEditUser(data: data), id: 1);},
