...
import 'package:ticket/screens/three_web_screens/three_web_logs/three_web_add_logs.dart';
...
class ThreeWebLogs extends StatefulWidget {
  const ThreeWebLogs({super.key});

  @override
  State<ThreeWebLogs> createState() => _ThreeWebLogsState();
}

class _ThreeWebLogsState extends State<ThreeWebLogs> {
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              WebElevatedButton(
                onTap: () {
                  Get.to(() => const ThreeWebAddLogs(), id: 3);
                },
